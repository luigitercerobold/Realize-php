                ...
                <div class="res">
                    ...
                    <div class="row">
                        <div class="col-lg-4 percentage-container">
                            <div class="elem">
                                <h1>1-<span style="color: #e0a800;">8%</span> </h1>
                                <p>Aumento esperado de utilidad anual</p>
                            </div>
                            <div class="vline"></div>
                        </div>
                        <div class="col-lg-4 percentage-container">
                            ...
                            <div class="elem">
                                <h1>2-<span style="color: #e0a800;">5%</span> </h1>
                        ...
                        <div class="col-lg-4 percentage-container">
                            <div class="elem">
                                <h1>5-<span style="color: #e0a800;">10%</span> </h1>
                                <p>Aumento de márgenes de utilidad</p>
                            </div>
                        </div>
